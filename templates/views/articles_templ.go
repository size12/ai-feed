...
func NewArticles(articles []*Article, themes []*Theme, feederThemes []*Theme, personalities []*Personality, socials []*entity.SocialNetwork) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, article := range articles {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 468, Col: 71}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var2))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\"><details><summary><div class=\"content\"><h5><mark>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 472, Col: 46}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var3))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</mark></h5><div class=\"grid\"><button class=\"open\">Открыть</button> <button class=\"publish-article-btn outline\">Опубликовать</button> <button class=\"outline secondary delete\">Удалить</button> <button class=\"outline edit\">Редактировать</button></div></div></summary><h5><mark>Аналитика:</mark></h5><ul><li><h6>Количество слов - <i>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 483, Col: 81}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 484, Col: 91}
			}
			...
			for index, el := range article.Keywords {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 489, Col: 52}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 489, Col: 63}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 489, Col: 79}
				}
		...
		if len(themes) > 0 {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<option disabled>Мои темы</option> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for _, theme := range themes {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 520, Col: 58}
				}
		...
		if len(feederThemes) > 0 {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<option disabled>Темы с интернета</option> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for _, theme := range feederThemes {
				...
				templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(theme.Description)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 526, Col: 59}
				}
		...
		for _, personality := range personalities {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(personality.Biography)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 538, Col: 64}
			}
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(personality.Keywords)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 539, Col: 63}
			}
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(personality.Thematics)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 540, Col: 65}
			}
			...
			templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(personality.TextStyle)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 541, Col: 66}
			}
			...
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(personality.Name)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 542, Col: 46}
			}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</select></label> <label>Заголовок статьи <input id=\"article-title\" type=\"text\" name=\"title\" placeholder=\"Кликбейтный заголовок 1\" value=\"\"></label> <label>Текст статьи <textarea id=\"article-content\" name=\"content\" rows=\"10\" placeholder=\"Напишите или сгенерируйте статью\" aria-label=\"Напишите или сгенерируйте статью\"></textarea></label> <button id=\"generate-content\" class=\"outline\">Сгенерировать статью </button><br><br><img id=\"article-image\"><br><br><button id=\"generate-image\" class=\"outline\">Сгенерировать изображение</button><br></form><footer><button id=\"save-article-btn\">Создать</button></footer></article></dialog> <dialog id=\"publish-dialog\"><article><header><button aria-label=\"close\" rel=\"prev\" id=\"close-dialog\"></button><p><strong>Публикация поста</strong></p></header><form id=\"create-form\"><label>Куда публикуем? <select id=\"select-social\" name=\"social\" aria-label=\"Выберите социальную сеть...\" required><option selected disabled value=\"\">Выберите социальную сеть</option> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, social := range socials {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<option data-id=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var16 string
			templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(social.ID.String())
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 585, Col: 58}
			}
			...
			templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(social.Name)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 586, Col: 39}
			}
			...
			templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(social.Type)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/views/articles.templ`, Line: 586, Col: 55}
			}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</select></label> <label>Когда публикуем? <input type=\"text\" id=\"datepicker\" placeholder=\"Выберите дату и время\"></label></form><footer><button id=\"publish-to-social-btn\">Опубликовать</button></footer></article></dialog></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
